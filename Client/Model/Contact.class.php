...
function __construct($nompre_cont,$email_cont,$sujet,$message){
...
include('../includes/connect_db.php');
		...
		$req = $bdd->exec("INSERT INTO `contact`(`nompre_cont`, `email_cont`, `sujet`, `message`)	
    VALUES ('$this->nompre_cont','$this->email_cont','$this->sujet','$this->message')");
