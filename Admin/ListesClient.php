                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="mt-0 header-title">Listes des clients</h4>
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $donnees['nom_cl'] ?></td>
                                                <td><?php echo $donnees['prenom_cl'] ?></td>
                                                <td><?php echo $donnees['login_cl'] ?></td>
                                                <td><?php echo $donnees['email_cl'] ?></td>
                                                <td><?php echo $donnees['passport'] ?></td>
                                                <td><a href="ModifierClient.php?id=<?php echo $donnees['id_cl'] ?>" >
                                                    <button type="button" class="btn btn-success" >Modifier</button></a>
                                                     <a href="Controller/suppClient.php?id=<?php echo $donnees['id_cl'] ?>">
