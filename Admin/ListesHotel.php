                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    <h4 class="mt-0 header-title">Listes des Hotels</h4>
                                    
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap">
                                        <thead>
                                        <tr>
                                            <th class="col-3">Nom Hotel</th>
                                            <th class="col-3">Num Chambre</th>
                                            <th class="col-3">Type Chambre</th>
                                        ...
                                        ?>
                                            <tr>
                                                <td><?php echo $donnees['nom_hot'] ?></td>
                                                <td><?php echo $donnees['numch_hot'] ?></td>
                                                <td><?php echo $donnees['typech_hot'] ?></td>
                                                <td><a href="ModifierHotel.php?id=<?php echo $donnees['id_hot'] ?>" >
                                                    <button type="button" class="btn btn-success" >Modifier</button></a>
                                                     <a href="Controller/suppHotel.php?id=<?php echo $donnees['id_hot'] ?>">
